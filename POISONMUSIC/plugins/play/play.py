...
from POISONMUSIC.utils.decorators.play import PlayWrapper
from POISONMUSIC.utils.errors import capture_err, capture_callback_err
from POISONMUSIC.utils.formatters import formats
from POISONMUSIC.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from POISONMUSIC.utils.logger import play_logs
...
@app.on_callback_query(filters.regex("Poison Playlists") & ~BANNED_USERS)
@languageCB
@capture_callback_err
